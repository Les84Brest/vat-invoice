...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Services\Companies\CompanyServiceContract' => \App\Services\Companies\CompanyService::class,
            'App\Services\Invoices\InvoiceServiceContract' => \App\Services\Invoices\InvoiceService::class,
            'App\Services\Users\UserServiceContract' => \App\Services\Users\UserService::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/vat-invoice/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./var/www/vat-invoice/public/storage','logging.default','logging.deprecations.channel',
...
'broadcasting.connections.null.driver','concurrency.default','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'sanctum.csrf-cookie','posts.index','posts.store',
'posts.show','posts.update','posts.destroy','invoice.index',
'invoice.store','invoice.show','invoice.update','invoice.destroy',
'admin.login','admin.register','admin.dashboard','user.index',
'user.create','user.store','user.show','user.edit','user.update',
'user.destroy','company.index','company.create','company.store','company.show',
'company.edit','company.update','company.destroy','invoice.index','invoice.create',
'invoice.store','invoice.show','invoice.edit','invoice.update','invoice.destroy',
'login','logout','register',
'password.request','password.email','password.reset','password.update','password.confirm','storage.local',);
        registerArgumentsSet('views', 
'admin.company.create','admin.company.index','admin.company.show-edit','admin.components.content-header','admin.components.footer',
'admin.components.sidebar','admin.dashboard','admin.invoice.index','admin.layouts.admin','admin.layouts.auth',
'admin.login','admin.register','admin.user.index','admin.user.show-edit','auth.login',
'auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register','auth.verify',
'home','layouts.app','vue','welcome','laravel-exceptions-renderer::components.card',
